<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarCustomer.aspx.cs" Inherits="GESTION.PagoFacturas.AgregarCustomer" %>
...
<body>
    ...
    <div>
     <table class="auto-style1">
            <tr>
                <td colspan="2" class="auto-style8"><strong>Agregar Customer</strong></td>
            </tr>
            <tr>
                <td class="auto-style12"><strong>Nombre Customer</strong></td>
            ...
            <tr>
                <td class="auto-style12"><strong>Correo</strong></td>
                <td class="auto-style13">
                    <strong>
                    <asp:TextBox ID="txtCorreo" runat="server" Height="25px" Width="200px" TextMode="Email"></asp:TextBox>
                    </strong>
                </td>
            </tr>
            <tr>
